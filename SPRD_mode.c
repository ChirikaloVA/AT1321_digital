...
/*}else
	{//overload of max doserate
		...
		Display_setTextColor(clr);	//set text color
		Display_clearTextWin(250);
		Display_outputTextByLang("OVERLOAD\0""OVERLOAD\0""OVERLOAD\0""ПЕРЕГРУЗ");
	}*/
}
...
#endif
/*		case enu_dim_gy:
			return "µGy/h\0""µGy/h\0""µGy/h\0""µГр/ч";
		case enu_dim_r:
			return "µR/h\0""µR/h\0""µR/h\0""µРем/ч";
	default:
...
#endif
/*		case enu_dim_gy:
			return "µGy\0""µGy\0""µGy\0""µГр";
		case enu_dim_r:
			return "µR\0""µR\0""µR\0""µРем";
	default:
		exception(__FILE__,__FUNCTION__,__LINE__,"Internal error");
	}
	return NULL;*/
...
void SPRDMode_menu1_datetime_dayw_done(BOOL bOK)
{
	...
	EditMode_EditInt_ex("Enter day of year\0""Enter day of year\0""Enter day of year\0""Введите день года",
