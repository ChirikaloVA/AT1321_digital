...
//количество окон дл€ расчета спектр дозы
#define SD_WIN_SIZE 17


struct tagSpectrumControl
{	
	//таблица канал энерги€
	...
	BOOL bHasSigma;
	WORD warSigma[CHANNELS];	//здесь хранитс€ сигма в 1,5 уже чем калибровочна€, это нужно дл€ поиска слитых пиков. во всех остальных местах кроме идентификации нажуно множить ее на 1,5
        int warDRkoef[SD_WIN_SIZE+2];
...
//	int specTablePage;	//страница отображени€ таблицы спектров
