...
/*
начальное значение CRC должно быть 0xffffffff
...
char* CRC32ROM(char* pStrCrc)
{
	...
	unsigned char* pEnd = (unsigned char*)endfunction+8+4;	//+8 - это команда выхода из функции; +4 это контрольная сумма
...
//        crc = 0x55;
	...
	sprintf(&pStrCrc[2*3],"%02x", (UINT)((crc)&0xff));
	pStrCrc[2*4] = 0;
	return pStrCrc;
}
...
/*
unsigned char reverseCrc32Table[256] =
{
